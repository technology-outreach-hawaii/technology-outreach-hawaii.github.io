...
- **Git**
- **Node.js** and **npm** (for FullCalendar dependency)
...
**Recent deployments:**
- Latest: March 5, 2025 (commit: 58f7edb)
...
**Current sponsor:** AFCEA Hawaii (replaced Bell Charitable Foundation)
...
This repository is **private** and access is limited to:
- Technology Outreach Hawaii development team members
- Authorized contributors with explicit repository access
